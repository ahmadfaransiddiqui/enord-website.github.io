!function (t) {
    ...
    ([
        function (t, e, n) {
            "use strict";
            n.r(e);
            var i = n(1), r = n(3), o = n(22), a = n(9), s = n(10), c = n(23), l = n(11), d = n(24), u = n(25), f = n(26), h = n(35), p = n(36), m = n(37), g = n(38), v = n(39), b = n(40);
        ...
        function (t, e, n) {
            "use strict";
            n.r(e), n.d(e, "default", (function () { return effectAnimate }));
            var i = n(2), r = n(4), o = n(6), a = n(8), s = n(12), c = n(13), l = n(14), d = n(15), u = n(17), f = n(18), h = n(19), p = n(20), m = n(21);
            function effectAnimate() {
                return {
                    allInt: function () {
                        const t = async function clearControl() {
                            await ScrollTrigger.getAll().forEach((function (t) {
                                t.kill()
                            })), await ScrollTrigger.update()
                        }();
                        jQuery(".use-horizontal-scroll , [data-dsn-animation] , .use-horizontal-scroll-image").each((e, n) => { const i = jQuery(n).parent(); t.then(() => { Object(d["default"])(i), Object(l["default"])(i), Object(p["default"])(i) }) }), t.then(i["default"]).then(r["default"]).then(o["default"]).then(a["default"]).then(s["default"]).then(c["default"]).then(u["default"]).then(f["default"]).then(h["default"]).then(m["default"]).then(() => { if (document.querySelector(".gsap-marker-scroller-start")) { const t = gsap.utils.toArray('[class *= "gsap-marker"]'); $effectScroll.getListener(({ offset: e, x: n, y: i }) => gsap.set(t, { marginTop: -i }), !1) } })
                    }, parallaxHover: r["default"], parallaxImg: o["default"], animateSkills: c["default"], animateWorkScroll: l["default"], animateImageScroll: p["default"], customAnimation: d["default"], animateFade: f["default"], nextPage: a["default"]
                }
            }
        },
        function (t, e, n) {
